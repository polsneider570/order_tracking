...
<head>
    ...
    <title>Horizon<?php echo e(config('app.name') ? ' - ' . config('app.name') : ''); ?></title>
        ...
        <div class="d-flex align-items-center py-4 header">
            <router-link to="/" class="logo d-flex align-items-center">
                ...
                <h1 class="h4 mb-0 ms-2">
                    <strong>Laravel</strong> Horizon<?php echo e(config('app.name') ? ' - ' . config('app.name') : ''); ?>
...
<?php /**PATH /var/www/laravel/vendor/laravel/horizon/src/../resources/views/layout.blade.php ENDPATH**/ ?>